...
export default function upperDashboard() {
    ...
    return (
        <section>
            <div className="lg:flex-row-reverse lg:flex justify-evenly mt-5 mb-5">           
                <div className="lg:flex lg:flex-col mb-5 flex flex-col items-center">
                    ...
                    <h2 className="flex justify-end text-slate-200 text-2xl font-bold font-visby-regular lg:text-center">{memberName}</h2>
                    <p className="flex justify-end text-gray-500 text-base font-visby-regular lg:text-right">{memberTeam}</p>
                </div>
                <div className="flex flex-col lg:items-center gap-10 lg:flex-row lg:h-40 lg:mt-8">
                    <div className="border-2 rounded-xl border-gray-500 py-5 px-7 h-full">
                        <h2 className="text-slate-200 font-bold text-xl mb-2">Achievements completed</h2>
