    ...
    <div>
      <main className="bg-neutral-950 px-10 md:px-20 lg:px-40">
        <section className="min-h-screen">
          <NavHome/>
          <div className='flex flex-col mt-20 lg:flex-row lg:justify-around lg:-mt-2 gap-3'>
