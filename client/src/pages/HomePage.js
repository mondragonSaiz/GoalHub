            ...
            <div className='mt-10 lg:w-1/3'>
              ...
              <div className='mt-10'>
                <input 
                  ...
                  type="text"
                  className=' focus:text-slate-200 text-slate-200 bg-neutral-950 border-2 rounded-lg border-gray-500 text-left pl-4 py-1 mr-4 lg:text-lg lg:w-3/5 xl:w-1/2'
                />
