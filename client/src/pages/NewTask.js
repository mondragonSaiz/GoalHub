    ...
    <main className="flex justify-center bg-neutral-950 px-10 md:px-20 lg:px-40">
        <section className="flex pt-24 min-h-screen">
            <div className="flex flex-col justify-center items-center lg:-mt-20 mt-10 mb-10">
             <h1 className="text-slate-200 text-2xl font-bold lg:text-4xl mb-5 text-center">New Task +</h1>
                <div className="flex flex-col items-center w-auto border-2 rounded-2xl border-slate-200 px-14 py-14 gap-8">
                    ...
                    <div className="flex flex-row lg:flex-col gap-16">
                      ...
                      <div className="flex lg:flex-row gap-16"> 
                        <div className="flex">
                          <h1 className="text-slate-200 font-medium text-xl text-left ">Title</h1>
                        </div>
                      ...
                      <div className="flex flex-col lg:flex-row gap-16">
                        <div>
                        <h1 className="text-slate-200 font-medium text-xl text-left">Description</h1>
                        </div>
                        <div>
                ...
                <a href="/sign-up-form" className='flex bg-gray-100 text-neutral-950 py-2 px-20 font-mediumfont-poppins rounded-full lg:text-lg justify-center w-auto cursor-default'>Assign </a>
                </div>
