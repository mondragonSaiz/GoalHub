                ...
                <section className="flex min-h-screen">
                    <div className="flex flex-col justify-center items-center lg:-mt-20">
                        ...
                        {data ? (
                                    ...
                                    ) : (<div className="flex flex-col items-center w-auto rounded-2xl border-slate-200 gap-8">
                            ...
                            <form action="" className="flex flex-col gap-6">
                                ...
                                <input 
                                    ...
                                    className=' focus:text-slate-200 text-slate-200 bg-neutral-950 border-2 rounded-lg border-gray-500 text-left py-2 pr-56 pl-4'
                                />
                                <input type="submit" onClick={handleFormSubmit} name="loginSub" id="loginSub" value="Log In" className=" bg-slate-200 text-neutral-950 rounded-lg py-2 px-36 cursor-pointer"/>
                            </form>
...
>>>>>>> 9e1182d806630141284ca8335024855ba93c139c
