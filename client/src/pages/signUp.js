                        ...
                        <div className="flex flex-col items-center w-auto border-2 rounded-2xl border-slate-200 px-14 py-14 gap-8">
                            ...
                            <div className="flex flex-col lg:flex-row gap-16">
                                <button id="employee" onClick={handleClick }className="w-80 h-auto border-2 rounded-2xl border-slate-200 hover:border-4 cursor-pointer">
                                    <div className={!isEmployee? "visible btn-employee border-slate-200 border-2 rounded-full w-10 h-10 mt-4 ml-64  mb-10":"bg-white visible btn-employee border-slate-200 border-2 rounded-full w-10 h-10 mt-4 ml-64 mb-10"}></div>
                                ...
                                <button id="manager" onClick={handleClick}  className="w-80 h-auto border-2 cursor-pointer rounded-2xl border-slate-200 hover:border-4 ">
                                    <div  className={isEmployee? "visible btn-employee border-slate-200 border-2 rounded-full w-10 h-10 mt-4 ml-64  mb-10":"bg-white visible btn-employee border-slate-200 border-2 rounded-full w-10 h-10 mt-4 ml-64  mb-10"}></div>
                            ...
                            <Link to="/sign-up-form" state={{isEmployee: isEmployee}} className='flex bg-gray-500 text-neutral-950 py-2 px-20 font-mediumfont-poppins rounded-full lg:text-lg justify-center w-auto cursor-default'>Apply as {isEmployee? 'a Employee': 'a Manager'}</Link>
